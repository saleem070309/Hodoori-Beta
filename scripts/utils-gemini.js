...
const Gemini = {
    ...
    async transcribeAudio(audioBase64, format = 'wav') {
        ...
        else if (format === 'mp4') mimeType = 'audio/mp4';
                ...
                "messages": [
                    {
                        ...
                        "content": [
                            {
                                "type": "text",
                                "text": "Listen to this audio and transcribe exactly what is said. Respond ONLY with the transcription. Do not include introductory text, polite expressions, notes or comments. If the audio is in Arabic, write in Arabic. If it's English, write in English."
                            },
                            {
                                "type": "image_url",
                                "image_url": {
